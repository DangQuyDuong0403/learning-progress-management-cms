const ROUTER_PAGE = {
	...
	TEACHER_DAILY_CHALLENGE_SUBMISSIONS: '/teacher/daily-challenges/detail/:id/submissions',
	TEACHER_DAILY_CHALLENGE_SUBMISSION_DETAIL: '/teacher/daily-challenges/detail/:id/submissions/:submissionId',
	TEACHER_DAILY_CHALLENGE_AI_FEEDBACK: '/teacher/daily-challenges/detail/:id/submissions/:submissionId/feedback/:submissionQuestionId',
	TEACHER_DAILY_CHALLENGE_CONTENT: '/teacher/daily-challenges/detail/:id/content',
	TEACHER_DAILY_CHALLENGE_PREVIEW: '/teacher/daily-challenges/detail/:id/preview',
