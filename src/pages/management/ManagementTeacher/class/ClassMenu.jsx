  ...
  const menuItems = [
    {
      ...
      path: `/teacher/classes/dashboard/${id}`,
      color: "#1890ff",
    },
    {
      id: "students",
      ...
      path: `/teacher/classes/student/${id}`,
      color: "#52c41a",
    },
    {
      id: "teachers",
      ...
      path: `/teacher/classes/teachers/${id}`,
      color: "#fa8c16",
    },
    {
      id: "activities",
      ...
      icon: <HistoryOutlined style={{ fontSize: '48px', color: '#722ed1' }} />,
      path: `/teacher/classes/activities/${id}`,
      color: "#722ed1",
    },
    {
      id: "chapters-lessons",
      ...
      icon: <BookOutlined style={{ fontSize: '48px', color: '#eb2f96' }} />,
      path: `/teacher/classes/chapters-lessons/${id}`,
      color: "#eb2f96",
    },
  ];
