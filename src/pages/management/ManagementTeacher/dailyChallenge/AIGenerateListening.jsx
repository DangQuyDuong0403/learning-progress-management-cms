      ...
      const toApiQuestion = (q, orderNumber) => {
        ...
        switch (q.type) {
          ...
          case 'DRAG_AND_DROP': {
            ...
            return { questionText: q.questionText || q.question || '', orderNumber, weight: q.points || 1, questionType: q.type, content: { data: itemsWithDuplicateIndices }, toBeDeleted: false };
          }
          case 'REARRANGE': {
            const rawItems = toData(q.content?.data);
