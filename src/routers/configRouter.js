...
import LevelList from '../pages/management/ManagementManager_Fix/level/LevelList.jsx';
import SyllabusList from '../pages/management/ManagementManager_Fix/syllabus/SyllabusList.js';
import StudentList from '../pages/management/ManagementManager_Fix/Student/StudentList.js';
import StudentProfile from '../pages/management/ManagementManager_Fix/Student/StudentProfile.js';
import StudentLearningProgressOverview from '../pages/management/ManagementManager_Fix/Student/StudentLearningProgressOverview.js';
import TeacherList from '../pages/management/ManagementManager_Fix/teacher/TeacherList.js';
import TeacherProfile from '../pages/management/ManagementManager_Fix/teacher/TeacherProfile.jsx';
import SpinnerDemo from '../pages/SpinnerDemo.jsx';
//manager
import ClassList from '../pages/management/ManagementManager_Fix/Class/ClassList.js';
import ClassMenu from '../pages/management/ManagementManager_Fix/Class/ClassMenu.js';
import ClassDetail from '../pages/management/ManagementManager_Fix/Class/ClassDetail.js';
import ClassTeachers from '../pages/management/ManagementManager_Fix/Class/ClassTeachers.js';
import ClassActivities from '../pages/management/ManagementManager_Fix/Class/ClassActivities.js';
import ClassChapterLesson from '../pages/management/ManagementManager_Fix/Class/ClassChapterLesson.js';
